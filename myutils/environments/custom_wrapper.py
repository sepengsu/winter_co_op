...
class ActuatorWrapper(SconeWrapper):
    def __init__(self, env):
        super().__init__(env)
...
class ClipCustomWrapper(SconeWrapper):
    def __init__(self, env, clip_actions = True, max_activation = 0.5):
        super().__init__(env)
...
class MotorWarpper(SconeWrapper):
    def __init__(self, env):
        super().__init__(env)
