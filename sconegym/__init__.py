...
register(id="sconewalk_h1922-v1",
         entry_point="myutils.environments.mysconegym:Gait1922",
         kwargs={
...
register(id="sconewalk_act_h1922-v1",
...
register(id="sconewalktreadmill_h1922-v1",
         entry_point="sconegym.gaitgym:GaitGym",
         kwargs={
...
register(id="sconewalk_harness_h1622-v1",
         entry_point="sconegym.gaitgym:GaitGym",
         kwargs={
